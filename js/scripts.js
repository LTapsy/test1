...
(function($) {
    ...
    function csubmitForm() {
        ...
        $.ajax({
            ...
            data: "name=" + name + "&email=" + email + "&terms=" + terms +"&consent=" + terms + "&user_name=" + name + "&reff=" + 'NA' +"&message=" + message + "&province=" + province, 
            success: function(text) {
                if (text.includes("Success")) {
                    ...
                    console.log("failed");
                    console.log(text);
                    csubmitMSG(false, 'Please Try Again!!!');
                }
            }
        });
	}
    ...
    function cformSuccess() {
        $("#contactForm")[0].reset();
        csubmitMSG(true, "Thank you for joining Tulu!");
        $("input").removeClass('notEmpty'); // resets the field label after submission
